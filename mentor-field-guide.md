...
Teaching is sometimes the best way to learn. Have the student teach you a concept that they learned the prior week. This will be great reinforcement and will help the student discover gaps in her learning, without you having to directly call them out. 
...
In plain English, this means that whenever possible, you should try to avoid directly answering students’ questions and instead ask the student smaller questions that help guide him or her to the right answer. For example, if a Python student were to ask:
...
Routine remedies this! By having an established procedure for running the mentor session, your student engages with a high quality session every single time without you thinking too much about it. Make sure to firmly set these routine into motion from the first session.
...
We understand that life happens (even to the best of us!), and there may be sessions you are simply unable to attend due to health, family, travel, or other reasons. When this happens, you are welcome to connect with your student and try to reschedule for another time *that week*. If you expect to be absent for more than a week, or cannot reschedule with your student, please contact support@thinkful.com for help. 

**My student didn't do any work this week. At all.**

Use scaffolding and the Socratic Method to work with the student on their current spot in the course. There will be times where you may have to teach a concept explicitly. When in doubt, you can always share your screen and simply start coding yourself, introducing concepts and asking scaffolding questions as your student watches on. 
