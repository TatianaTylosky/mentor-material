#Table of Contents
**Chapter 1** | Our Learning Philosophy

**Chapter 2** | Anatomy of a First Mentor Session

**Chapter 3** | 8 Tips on How to Have a Badass First Mentor Session

**Chapter 4** | Mentorship Behind the Scenes
...
<!---
We may be updating the when and what, and how of the first mentor session. 

	What, if anything, would we like the mentor to do in advance of the first session? Email student? Host a short mentor session before that. 

This session is also based on a 30-minute session - do we want to include a note for where to put the extra 15 minutes in other courses?
-->
...
You will lean more psychologist than educator for this first session. Ask your student about her backstory, motivations, and dreams. (<20 minutes)

**Goal Breakdown**

Paint a vivid picture of the path your student must take to get from where she is now to where she wants to be -- emphasizing where Thinkful fits within that journey. (<4 minutes)

**Set High Expectations and Routines**

This is your pep talk. Firmly express what your student needs to do -- how much they have to commit -- to ultimately reach their goal. (<4 minutes)

**Closing End of Session**

That’s all folks! (Remember to close by setting the weekly SPRINT Goal with your student!)
￼
##Chapter 3
####8 Tips on How to Have a Badass First Mentor Session

Below are 8 tips on how to make an incredible first impression that will inspire your students.
...
About 2/3rds or 66.667% of the session should consist of the *student* speaking (20-30 minutes). This keeps the student engaged, and gives you the opportunity to show that you care about her goals. This foundation of care is essential to build the rapport necessary for true learning. To keep meaningful conversation going, have core questions and clarifying questions prepared. You can find a list of awesome clarifying questions in Chapter 6.
...
Our students are not learning to program just for the hell of it -- they’re learning because it will enable a dream. They want to work for themselves and and have more time to travel, work at an interesting startup with an ambitious mission, or simply make more money. Whatever the dream is, you want to know it. Use your Jedi questioning skills to draw this information out, and then validate that dream. Supporting your student will have a huge, positive impact on her learning, but only if the student follows up with committed skill building.

<!---
	What do the last two sentences mean, in terms of behaviors for the student and/or mentor?
-->

**4 | Prepare Clarifying Questions**

For this first session, it is critical to draw deep answers from students. It's... 
<!---
	What else is it? Text ended here.
-->
...
An ambiguous dream like “finding a job at a startup” is not helpful. The skills your student will need to demonstrate to get ahead are made up of sub-skills and objectives. Help your student create a clear, measurable path to achieving her dream. In this phase, it's essential that you share how your student's work with Thinkful fits within her journey to achieving her dream. More often than not, Thinkful is an early step towards building the foundational skills she needs to navigate the path on her own . 

**6 | Set Ambitious and Achievable Goals**

No matter how motivated students are, what courses they take, or how much they pay, students will not be able to achieve their goals unless they create the conditions for rigorous learning.
...
* Engagein the Slack community. Getting quick feedback on projects is critical. Read through and critique other students’ code. Understanding a codebase someone else wrote is a valuable skill.
* Each week, no matter what, fill out your RECAP form.

<!--- 
	What is RECAP turning into?
-->
...
**8 | Be Short and Sweet When Talking About Yourself - Show Don't Tell**

You only need two sentences to introduce your background. You’d be surprised how quickly students will pick it up from there with questions.
...
<!---
	This section is embedded in a circle; leaving it alone for now.
-->
...
There are different levels of questions. Lower level questions are easier and have clear, right or wrong answers. Higher level questions are harder and involve application of a variety of concepts within a real world setting. The “Scaffolding Questions” technique uses low level questions to build up to higher level questions. Many mentors fall into the trap of preserving student self esteem by dumbing down questions and never challenging students adequately or asking higher level questions too early in a session, which leavesstudents confused.
...
Many students can make something that works without understanding *why* it works. Asking them to “walkthrough” the code, explaining what each line does, allows them to recognize the “why” behind each action.
...
<!---
	Link to some other cool analogies? Just list some?
-->
...
<!---
	Good content, but needs some reworking towards the end. "Sole existence" is a bit extreme
-->
